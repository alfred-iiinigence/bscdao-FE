...
function Stake() {
  ...
  const onChangeStake = async action => {
    ...
    if (action === "unstake" && gweiValue.gt(ethers.utils.parseUnits(sohmBalance, "gwei"))) {
      return dispatch(error(t`You cannot unstake more than your sBSCDAO balance.`));
    }
                ...
                <Grid container spacing={2} alignItems="flex-start">
                  ...
                  <Grid item xs={12} sm={4} md={4} lg={4}>
                    <div className="stake-index">
                      ...
                      <Typography variant="h4">
                        {currentIndex ? (
                          <span data-testid="index-value">{trim(currentIndex, 1)} BSCDAO</span>
                        ) : (
                    ...
                    <Box className="stake-action-row " display="flex" alignItems="center">
                            ...
                            <Typography variant="body1" component="span" className="stake-note" color="textSecondary">
                              {view === 0 ? (
                                <>
                                  ...
                                  <br />
                                  <Trans>Please approve sBSCDAO to use your</Trans> <b>BSCDAO</b>{" "}
                                ...
                                <>
                                  ...
                                  <br />
                                  <Trans>Please approve BSCDAO to use your</Trans> <b>sBSCDAO</b>{" "}
                      ...
                      <TabPanel value={view} index={0} className="stake-tab-panel">
                        {isAllowanceDataLoading ? (
                          ...
                          >
                            {txnButtonText(pendingTransactions, "staking", t`Stake BSCDAO`)}
                          </Button>
                        ) : (
                          <Button
                            className="stake-button"
                      ...
                      <TabPanel value={view} index={1} className="stake-tab-panel">
                        {isAllowanceDataLoading ? (
                          ...
                          >
                            {txnButtonText(pendingTransactions, "unstaking", t`Unstake BSCDAO`)}
                          </Button>
                        ) : (
                          <Button
                            className="stake-button"
                  ...
                  <div className={`stake-user-data`}>
                    <div className="data-row">
                      ...
                      <Typography component="span" variant="body1" id="user-balance">
                        {isAppLoading ? <Skeleton width="80px" /> : <>{trim(ohmBalance, 4)} BSCDAO</>}
                      </Typography>
                    </div>
                    ...
                    <div className="data-row">
                      ...
                      <Typography component="span" variant="body1" id="user-staked-balance">
                        {isAppLoading ? <Skeleton width="80px" /> : <>{sohmBalance} sBSCDAO</>}
                      </Typography>
                    </div>
                    ...
                    <div className="data-row">
                      ...
                      <Typography component="span" variant="body1">
                        {isAppLoading ? <Skeleton width="80px" /> : <>{nextRewardValue} sBSCDAO</>}
                      </Typography>
                    </div>
