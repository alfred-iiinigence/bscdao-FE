...
import { trim, getTimeFromBlockForBonds, prettifySeconds, prettyVestingPeriod } from "../../helpers";
        ...
        <Box className="bond-data">
          <div className="data-row">
            ...
            <Typography className="price-data">
              {isBondLoading ? <Skeleton width="100px" /> : `${trim(bond.interestDue, 4)} FTMDAO`}
            </Typography>
          </div>
          <div className="data-row">
            <Typography>
            ...
            <Typography id="claimable" className="price-data">
              {isBondLoading ? <Skeleton width="100px" /> : `${trim(bond.pendingPayout, 4)} FTMDAO`}
            </Typography>
          </div>
          <div className="data-row">
            <Typography>
