...
import { prettifySeconds, getTimeFromBlockForBonds, shorten, trim } from "../../helpers";
...
function BondPurchase({ bond, slippage, recipientAddress }) {
  ...
  const vestingPeriod = () => {
    ...
    console.log(`🚀 - vestingPeriod - parseInt(bond.vestingTerm)`, parseInt(bond.vestingTerm));
    console.log(`🚀 - vestingPeriod - currentBlock`, currentBlock);
    console.log(`🚀 - vestingPeriod - vestingBlock`, vestingBlock);
    const seconds = getTimeFromBlockForBonds(currentBlock, vestingBlock);
    console.log(`🚀 - vestingPeriod - seconds`, seconds);
    //* Vesting period when less than single day the below commented code would return 0 days.
    //* So now it returns vesting period in hours and minute format
  ...
  console.log(`🚀 - BondPurchase - displayUnits`, bond.balance);
                  ...
                  <div className="help-text">
                    <em>
                      <Typography variant="body1" align="center" color="textSecondary">
                        ...
                        <Trans>Please approve FTMDAO to use your</Trans> <b>{bond.displayName}</b>{" "}
        ...
        <Box className="bond-data">
          ...
          <div className={`data-row`}>
            ...
            <Typography id="bond-value-id" className="price-data">
              {isBondLoading ? <Skeleton width="100px" /> : `${trim(bond.bondQuote, 4) || "0"} FTMDAO`}
            </Typography>
          </div>
          ...
          <div className={`data-row`}>
            ...
            <Typography id="bond-value-id" className="price-data">
              {isBondLoading ? <Skeleton width="100px" /> : `${trim(bond.maxBondPrice, 4) || "0"} FTMDAO`}
            </Typography>
          </div>
